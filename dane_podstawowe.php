...
<div id="page-wrapper">
	...
	if(isset($_SESSION['cloak_to'])){ ?>
		...
		<?php
			...
			$zapytanie = $db -> query("SELECT * FROM dane_podstawowe WHERE konto='$jakie_konto' AND dane_wniosku='$dane_wniosku'");
			...
			if($licz==0)
			{
			include("dane_podstawowe_insert.inc");
			//echo $licz;
			}
			else
			{
			include("dane_podstawowe_update.inc");
			//echo $licz;
			}
