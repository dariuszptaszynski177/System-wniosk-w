...
<div id="page-wrapper">
	...
	if(isset($_SESSION['cloak_to'])){ ?>
		...
		<?php
			$id_potwierdzenia = $_REQUEST['id_potwierdzenia'];
			//echo $id_potwierdzenia;

			$usun_potwierdzenie = $db-> query("DELETE FROM dane_potwierdzenie where id='$id_potwierdzenia'");
			header("Location: wyswietl_potwierdzenia.php");
		?>
