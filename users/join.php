...
$(document).ready(function(){
    ...
    function check_username_ajax(username){
        ...
        $.post('parsers/existingUsernameCheck.php', {'username': username}, function(response) {
            ...
            else if (response == 'taken') { $('#usernameCheck').html('<i class="glyphicon glyphicon-remove" style="color: red; font-size: 12px"></i> Nazwa użytkownika jest zajęta.');
            $('#next_button').prop('disabled', true); }
            else if (response == 'valid') { $('#usernameCheck').html('<i class="glyphicon glyphicon-ok" style="color: green; font-size: 12px"></i> Nazwa użytkownika jest dostępna.');
