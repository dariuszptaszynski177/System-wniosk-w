...
<div class="row">
	<div class="col-xs-12 col-md-3">
		...
		<p><a href="user_settings.php" class="btn btn-primary">Edytuj swoje konto</a></p>
	...
	<div class="col-xs-12 col-md-9">
		...
		<p>Zarejestrowany od :<?=$signupdate?></p>
		<p>Liczba logowań : <?=$user->data()->logins?></p>
		
		<?php
		$liczba_logowan=$user->data()->logins;
		//echo $liczba_logowan;
		
		if($liczba_logowan==1)
		{
		echo "<h2>Zalogowano do systemu pierwszy raz</h2><br />";
		echo "<h3>Tutaj możesz edtować dane o swoim koncie</h3>";
		echo "<h3>Przeczytaj instrukcję i wypełnij wniosek, klikając zakładkę <b>Wniosek</b></h3>";
		}
